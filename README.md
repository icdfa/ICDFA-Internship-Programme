...
**Platform:** NDG NETLAB+
**Description:** Develop the core offensive security skills required for roles such as Cyber Security Analyst, Penetration Tester, Ethical Hacker, Security Engineer, and Cyber Security Engineer. This course covers reconnaissance, scanning, vulnerability assessment, exploitation, and social engineering.
...
**Platform:** NDG NETLAB+
**Description:** Continuation of Offensive Security Operations I. This course covers advanced scanning methodology, enumeration, system hacking, web-based hacking, mobile hacking, and cryptography.
...
**Course Title:** Critical Infrastructure & ICS Security
...
**Course Title:** Digital Forensics & Evidence Analysis
**Duration:** 4 Weeks (Weeks 13-16)
**Platform:** NDG NETLAB+
**Description:** Develop the core digital forensics skills required for roles such as Computer Forensic Analyst, Digital Forensic Examiner, Digital Forensics Incident Response Specialist, and Security Administrator.
...
Unit 1: Corporate Data Breach Investigation (Week 19)
- Analysis of a corporate network intrusion
- Evidence collection from compromised servers
- Timeline reconstruction and attribution
- Forensic report writing

Unit 2: Mobile Device Forensics Case (Week 20)
- Extraction and analysis of mobile device evidence
- Application data recovery and analysis
- Location data and communication pattern analysis
- Expert witness report preparation

Unit 3: Ransomware Incident Response (Week 21)
- Ransomware attack chain analysis
- Encrypted file recovery techniques
- Malware reverse engineering fundamentals
- Incident response documentation

Unit 4: Insider Threat Investigation (Week 22)
- User activity monitoring and analysis
- Email and document exfiltration detection
- Registry and log correlation
- Legal and ethical considerations in insider investigations

Unit 5: Cloud Forensics Investigation (Week 23)
- Cloud service provider log analysis
- Virtual machine forensic acquisition
- Container and serverless forensics
- Cross-jurisdiction evidence handling

Unit 6: IoT and Embedded Device Forensics (Week 24)
- IoT device evidence extraction
- Firmware analysis and data recovery
- Network traffic analysis from IoT devices
- Emerging challenges in IoT forensics

Unit 7: Capstone Forensic Investigation (Week 25)
- Full-scale simulated forensic investigation
- Multi-source evidence correlation
- Professional forensic report submission
- Peer review and presentation

**Week 26:** Track B Final Assessment, Capstone Review, and Programme Wrap-Up
...
| Week 14 | CIP-A106 | Critical Infrastructure & ICS Security | Lab 01 - Lab 05 |
| Week 15 | CIP-A106 | Critical Infrastructure & ICS Security | Lab 06 - Lab 10 |
| Week 16 | CIP-A106 | Critical Infrastructure & ICS Security | Lab 11 - Lab 14, Cyber Range |
...
| Week 13 | CIP-B105 | Digital Forensics & Evidence Analysis | Lab 01 - Lab 05 |
| Week 14 | CIP-B105 | Digital Forensics & Evidence Analysis | Lab 06 - Lab 11 |
| Week 15 | CIP-B105 | Digital Forensics & Evidence Analysis | Lab 12 - Lab 16 |
| Week 16 | CIP-B105 | Digital Forensics & Evidence Analysis | Lab 17 - Lab 21, Cyber Range |
...
Primary lab delivery platform for all courses. Provides virtual lab environments for Linux, networking, ethical hacking, digital forensics, and security operations training.

**Cisco Networking Academy**
Network security and routing fundamentals. Provides structured learning paths and industry-recognised certification preparation.

**Palo Alto Networks**
Network security fundamentals, security operations, cloud security fundamentals, and cloud security automation courses. Provides next-generation firewall lab environments and security operations training.

**Microsoft Azure Academy**
Cloud infrastructure and security services. Provides Azure credits and cloud security training resources.
...
**Attendance Policy**
Interns are expected to maintain a minimum attendance rate of 90%. Unexcused absences exceeding 10% of the total programme hours may result in dismissal from the programme.

**Lab Discipline Policy**
All lab environments are professional training spaces. Interns must adhere to the following rules at all times:
...
**No-Retake Policy**
The programme operates under a strict no-retake policy. Interns who fail a course module will not be permitted to retake it within the same intake. Interns who wish to reattempt must apply for the next available intake.

**Academic Integrity**
All work submitted must be the intern's own. Plagiarism, collusion, or any form of academic dishonesty will result in immediate dismissal from the programme.

**Code of Conduct**
Interns are expected to conduct themselves professionally at all times. This includes respectful communication with instructors and peers, timely submission of assignments, and adherence to all programme policies.
